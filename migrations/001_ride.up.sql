...
create table rides (
    ...
    estimated_fare decimal(10,2), --бағасы
    final_fare decimal(10,2),--финал баға
    pickup_coordinate_id uuid not null references coordinates(id),
    destination_coordinate_id uuid not null references coordinates(id)
);
